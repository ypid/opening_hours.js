    ...
    es: {
        translation: {
            ...
            "texts": {
                ...
                "will close": "pero <a href=\"__href__\">cerrará</a> __timestring____comment__.",
                "will unknown": "pero <a href=\"__href__\">puede ser</a> que abra __timestring____comment__.",
                "will open": "pero <a href=\"__href__\">abrirá</a> __timestring____comment__.",
                "depends on": ", pero eso depende de __comment__.",
                ...
                "prettified value": 'valor embellecido de opening_hours (este valor puede ser usado con seguridad en OSM, después de haber <a href="__copyFunc__">resuelto</a> todas las advertencias)',
                ...
                "more information": "Para más información, puede consultar la <a __href__>wiki OSM</a>.",
                "this website": "Esta página web y la librería JavaScript usadas para la evaluación de las horas de apertura han sido desarrolladas en <a href=\"__url__\" target=\"_blank\">__hoster__</a>.",
                ...
                "map is showing": 'Este mapa está mostrando objetos con la etiqueta <a rel="external" href="__wikiUrl__">opening_hours</a> como círculos coloreados:',
                "error": "El valor no ha podido ser analizado",
                "warning": "Si han aparecido advertencias durante la evaluación, una __señal__ azul aparecerá en el icono de estado.",
                ...
                "data source": 'Los datos superpuestos provienen de __OSMStartaTag__ y han sido consultados usando la __APIaTag__. El mapa es __OSMaTag__.',
                ...
                "value to long for osm": 'El valor es demasiado largo para OSM. La base de datos de OpenStreetMap está actualmente limitada a valores de hasta __maxLength__ caracteres. El valor embellecido tiene una longitud de __pretLength__ y el valor que ha introducido tiene __valLength__ caracteres de longitud',
                "low zoom level": 'Los PDIs empezarán a aparecer en el nivel de zoom ${next} y superiores. Está actualmente en el nivel ${actual}.',
                "all n entries": 'Todas las __total__ entradas:',
                "the first entries": 'Las primeras __number__ of __total__ entradas:',
                ...
                "refer to yohours": 'Este valor puede ser analizado también por YoHours, que es un editor simpre para la sintaxis de opening_hours. Si no necesita funcionalidades avanzadas de la sintaxis, <a href=\"__href__\">puede darle una oportunidad</a>.',
                "include timestamp?": '¿incluir marca de tiempo?',
            },
            "words": {
                "modifier": "modificador __name__",
    ...
    hu: {
        translation: {
            ...
            "texts": {
                ...
                "will close": "de <a href=\"__href__\">bezár</a> ekkor: __timestring____comment__.",
                "will unknown": "de <a href=\"__href__\">kinyithat</a> ekkor: __timestring____comment__.",
                "will open": "de <a href=\"__href__\">kinyit</a> ekkor: __timestring____comment__.",
                "depends on": ", de ez ettől függ: __comment__.",
                ...
                "prettified value": 'Szépen formázott [opening_hours] érték. (Biztonságosan használható az OSM-ben, miután az összes figyelmeztetés <a href="__copyFunc__">meg lett oldva</a>.)',
                ...
                "more information": "További információkért nézze meg az <a __href__>OSM wiki</a> szócikkeit.",
                "this website": "Ennek a weboldalnak és a nyitva tartás kiértékeléséhez használt JavaScript programkönyvtárnak a fejlesztése a <a href=\"__url__\" target=\"_blank\">__hoster__</a> platformon zajlik.",
                ...
                "map is showing": 'Ez a térkép az <a rel="external" href="__wikiUrl__">[opening_hours]</a> címkével rendelkező objektumokat jeleníti meg színes körökkel:',
                "error": "A nyitva tartás kiértékelhetetlen",
                "warning": "Ha figyelmeztetés jelenik meg a kiértékelés közben, akkor az állapotikonban egy kék __sign__ látható.",
                ...
                "data source": 'A kiértékelendő adatok az __OSMStartaTag__ adatbázisából származnak, és az __APIaTag__ segítségével vannak lekérdezve. A térkép szerzői jogainak birtokosai: __OSMaTag__.',
                ...
                "value to long for osm": 'Az érték túl hosszú az OSM számára. Az OpenStreetMap adatbázisa jelenleg legfeljebb __maxLength__ karakter hosszúságú értékeket támogat. A szépen formázott érték __pretLength__ hosszúságú, a megadott érték viszont __valLength__ karakteres.',
                "low zoom level": 'A jelölők csak ${next} nagyítási szinttől kezdenek megjelenni. A  jelenlegi nagyítási szint: ${actual}.',
                "all n entries": 'Az összes (__total__) bejegyzés:',
                "the first entries": 'Az első __number__ bejegyzés (összes: __total__):',
                ...
                "refer to yohours": 'Ezt az értéket fel tudja dolgozni a YoHours is, egy felhasználóbarát címkeszerkesztő az opening_hours szintaxisához. Ha nincs szüksége a szintaxis speciális funkcióira, akkor YoHours remek eszköz. <a href=\"__href__\">Próbálja ki!</a>',
                "include timestamp?": 'tartalmazzon-e időbélyeget?',
            },
            "words": {
                "modifier": "__name__ módosító",
                "selector": "__name__ szelektor",
