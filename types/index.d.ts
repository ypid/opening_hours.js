export declare class opening_hours {
  constructor(value:string, nominatim_object?: nominatim_object | null, optional_conf_param?: optional_conf_param | null)
  ...
  getOpenIntervals(from: Date, to: Date): [ [ Date, Date, boolean, string | undefined ], [ Date, Date, boolean, string | undefined ] ]
  getStatePair(date?: Date) : [ boolean, Date, boolean, string | undefined, number | undefined ]
  getWarnings(): string[]
  isEqualTo(second_oh_object: opening_hours, start_date : opening_hours) : boolean
